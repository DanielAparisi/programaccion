...
int main() {
 ...
 //f) Crea una función que compruebe si una cadena es palíndromo.
  //strcpy( );   	//volvemos a cargar las cadenas iniciales en cadena_pal y cadena_nopal
  //strcpy( );
  //llamamos a esPalindromo pasándole cadena_pal
  //llamamos a esPalindromo pasándole cadena_nopal
